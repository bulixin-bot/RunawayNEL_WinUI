...
namespace Runaway.Protocol
{
    public static class Com4399Login
    {
        ...
        public static async Task<string> LoginWithPasswordAsync(string username, string password, string sessionId, string captcha)
        {
            try
            {
                ...
                parameters.Add("captcha_id", sessionId);
        ...
        private static string GenerateSAuth(string sdkUid, string sessionId, string channel, string platform = "ad")
        {
