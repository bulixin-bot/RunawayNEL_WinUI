...
using Runaway.Core.Api.Entities;
using Runaway.Core.Api.Entities.Auth;
using Runaway.Core.Api.Entities.System;
using Serilog;
using System;

namespace Runaway.Core.Api;
...
public class OxygenApi : IDisposable
{
    ...
    private const string RandomLoginApiKey = "f7e92f0658c7478ead0cfe136cf84ee7";
